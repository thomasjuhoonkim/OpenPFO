...
- `pfo createGeometry`: Resets the create_geometry function in `pfo/create_geometry.py` back to original settings. (WARNING: Your progress will be lost)
- `pfo resetModifyCase`: Resets the modify_case function in `pfo/modify_case.py` back to original settings. (WARNING: Your progress will be lost)
- `pfo resetCreateMesh`: Resets the create_mesh function in `pfo/create_mesh.py` back to original settings. (WARNING: Your progress will be lost)
- `pfo resetExecuteSolver`: Resets the execute_solver function in `pfo/execute_solver.py` back to original settings. (WARNING: Your progress will be lost)
- `pfo resetExtractObjectives`: Resets the extract_objectives function in `pfo/extract_objectives.py` back to original settings. (WARNING: Your progress will be lost)
- `pfo resetExtractAssets`: Resets the extract_assets function in `pfo/extract_assets.py` back to original settings. (WARNING: Your progress will be lost)
- `pfo resetExecuteCleanup`: Resets the execute_cleanup function in `pfo/execute_cleanup.py` back to original settings. (WARNING: Your progress will be lost)
