...
![Restarting an existing job during progress recovery\label{fig:progress-recovery}](paper_figs/progress-recovery.png)
...
![Illustration of a search structure including numerous jobs\label{fig:search}](paper_figs/search.png)
...
![Overview of OpenPFO software design\label{fig:openpfo-overview}](paper_figs/problem-and-algorithm.png)
...
Typically, the numerical outputs of OpenPFO alone are insufficient to effectively interpret their significance in the design space. To address this, a built-in web application called the report-viewer is also provided to visualize results and aid the user to accurately interpret optimization data produced by OpenPFO.
