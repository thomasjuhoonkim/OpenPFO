...
if __name__ == "__main__":
    ...
    Render()
    SaveScreenshot(
        f"{job_directory}/yplus-diagonal.png",
        renderView,
    ...
    Render()
    SaveScreenshot(
        f"{job_directory}/yplus-front.png",
        renderView,
        ImageResolution=renderView.ViewSize,
    )
    ...
    Render()
    SaveScreenshot(
        f"{job_directory}/yplus-side.png",
        renderView,
        ImageResolution=renderView.ViewSize,
    )
    ...
    Render()
    SaveScreenshot(
        f"{job_directory}/yplus-bottom.png",
        renderView,
        ImageResolution=renderView.ViewSize,
    )
